...
function createarray($zipcode, $dayofweek, $sev)
{
	...
	$sql = "SELECT * FROM `parkinglots` WHERE 1";
...
<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-dashboard fa-fw"></i>Parking</a>
                        </li>
						<li>
     ...
     <div id="mapDiv">
         ...
         <div class="col-lg-3" style="position:absolute; right:100px; top: 250px">
					<div class="panel panel-default">
					    ...
					    <br><br>
					    <button type="submit" class="btn btn-primary" id="Accidents">Plot Parking Lots</button> 
